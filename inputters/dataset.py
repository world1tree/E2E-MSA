...
def build_dataset(fields,
  ...
  # iter: {"src": (word1, word2, ...), "indices": line_no}
  ...
  dataset = Dataset(fields, src_examples_iter, tgt_examples_iter,
                        ...
                        use_filter_pred=use_filter_pred) # True
...
class Dataset(torchtext.data.Dataset):
  def __init__(self, fields, src_examples_iter, tgt_examples_iter,
    ...
    if tgt_examples_iter is not None:
      # src: {"src": (word1, word2, ...), "indices": line_no}
      # tgt: {"tgt": (word1, word2, ...), "indices": line_no}
      #  ||
      #  ||
      # \||/
      # {"src": (word1, word2, ...), "tgt": (word1, word2, ...), "indices": line_no}
    ...
    for ex_values in example_values:
      ...
      # example.src => tuple(str)
      # example.tgt => tuple(str)
      # example.indices => int
